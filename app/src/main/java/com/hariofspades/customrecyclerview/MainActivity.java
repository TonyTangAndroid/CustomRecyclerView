...
/**
 * Authuor: Hari vignesh Jayapalan Created on: 6 Feb 2016 Email: hariutd@gmail.com
 *
 * <p>Implementing custom RecyclerView Adapter Tutorial @ https://medium.com/@harivigneshjayapalan
 */
public class MainActivity extends AppCompatActivity {
        ...
        new RecyclerTouchListener(
            ...
            new ClickListener() {
                ...
                picture.setOnClickListener(
                    new View.OnClickListener() {
                      ...
                      public void onClick(View v) {
                        Toast.makeText(
                                MainActivity.this,
                                "Single Click on Image :" + position,
                                Toast.LENGTH_SHORT)
                            .show();
                      }
                    });
              ...
              public void onLongClick(View view, int position) {
                Toast.makeText(
                        MainActivity.this, "Long press on position :" + position, Toast.LENGTH_LONG)
                    .show();
              }
            }));
  ...
  private void populateRecyclerViewValues() {
    /**
     * This is where we pass the data to the adpater using POJO class. The for loop here is
     * optional. I've just populated same data for 50 times. You can use a JSON object request to
     * gather the required values and populate in the RecyclerView.
     */
   ...
   * RecyclerView: Implementing single item click and long press (Part-II)
   *
   * <p>- creating an Interface for single tap and long press - Parameters are its respective view
   * and its position
   */
   ...
   * RecyclerView: Implementing single item click and long press (Part-II)
   *
   * <p>- creating an innerclass implementing RevyvlerView.OnItemTouchListener - Pass clickListener
